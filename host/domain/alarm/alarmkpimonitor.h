#ifndef ALARMKPIMONITOR_H
#define ALARMKPIMONITOR_H
#include <QObject>
#include <QTimer>
#include <QMutex>
#include <QVector>
...
private slots:
    void onTick();
private:
    struct AlarmEventEntry { qint64 timestamp = 0; quint32 tagId = 0; QString tagName; };
    void pruneOldEvents();
    AlarmKpiSnapshot snapshotLocked() const;
