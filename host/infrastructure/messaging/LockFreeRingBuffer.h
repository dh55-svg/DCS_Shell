...
public:
    LockFreeRingBuffer() : m_enqueuePos(0), m_dequeuePos(0) {
...
// RingBufMessageBus: adapt LockFreeRingBuffer to IMessageBus
class RingBufMessageBus : public IMessageBus {
public:
    bool enqueue(const RawModbusData& data) override { return m_buffer.enqueue(data); }
    bool dequeue(RawModbusData& data) override { return m_buffer.dequeue(data); }
